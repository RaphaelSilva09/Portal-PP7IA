    ...
    sections: [
        ...
        },
        {
            ...
            texts: {
                ...
                block2_label: "Reportagem da Semana",
                block2_desc: "Análises e destaques editoriais",
                block2_cadence: "Semanal",
                block2_href: "/explorar?b=reportagem",
                block3_label: "Radar",
                block3_desc: "Ferramentas, startups e tendências",
                block3_cadence: "Contínuo",
                block3_href: "/explorar?b=radar",
        ...
        },
        {
            ...
            visible: true,
            texts: {
                label: "As 7 IAs parceiras",
                title_before: "A IA ",
                title_em: "amplifica",
                title_line2: "O julgamento é humano.",
                description:
                    "Sete inteligências artificiais trabalham nos bastidores do portal — cada uma com seu papel. A curadoria final, sempre, passa por uma mesa editorial humana.",
                ia1_name: "Claude",
        ...
        },
        {
            ...
            texts: {
                ...
                description:
                    "Uma curadoria por semana — sem ruído, sem listicles, sem hype. Cancele quando quiser, em um clique.",
            },
        },
    ],
};
