            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="relative overflow-hidden rounded-3xl group">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/8 to-blue-500/10" />
                        ...
                        <div className="relative z-10 p-8 lg:p-10">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <p className="text-text-secondary text-base sm:text-2xl max-w-3xl mx-auto tracking-tight px-4 leading-relaxed">
                                    ...
                                    <p className="text-text-secondary text-base sm:text-lg max-w-2xl mx-auto tracking-tight px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="group relative overflow-hidden rounded-3xl bg-card/80 backdrop-blur-sm border border-border p-6 hover:bg-accent/60 hover:border-purple-500/40 transition duration-300">
                        ...
                        {/* Conteúdo */}
                        <div>
                            <span className="text-xs text-purple-600 font-semibold uppercase tracking-wider mb-2 block">
                                Criador
                            </span>
