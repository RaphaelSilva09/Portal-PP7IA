...
import { ArrowRight, Library, Mail, Search, Sparkles } from "lucide-react";
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    {/* Card: Radar */}
                    <div className="col-span-1 group relative overflow-hidden rounded-3xl min-h-70 bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-orange-500/30 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)]">
                        <div className="relative z-10 h-full flex flex-col p-6 sm:p-8">
                            {/* Icon */}
