                ...
                <div id="last-especial" className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-3">
                                {latest.htmlAvailable ? (
                                    <a
                                        ...
                                        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-yellow-500/20 hover:bg-yellow-500/30 border border-yellow-500/30 hover:border-yellow-500/50 rounded-full text-white font-medium text-sm sm:text-base transition-all duration-300 whitespace-nowrap"
                                    >
                                ...
                                {latest.pdfAvailable ? (
                                    <a
                                        href={latest.pdfPath!}
                                        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/30 hover:border-amber-500/50 rounded-full text-white font-medium text-sm sm:text-base transition-all duration-300 whitespace-nowrap"
                                    >
                    ...
                    {older.map(item => (
                        <div
                            ...
                            className="col-span-1 group relative overflow-hidden rounded-3xl min-h-[200px] bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-yellow-500/30 hover:shadow-[0_0_30px_rgba(234,179,8,0.15)]"
                        >
                            <div className="relative z-10 h-full flex flex-col items-center text-center p-6 sm:p-8">
                                ...
                                <div className="flex flex-wrap md:flex-nowrap gap-3 mt-auto justify-center">
                                    {item.htmlAvailable ? (
                                        <a
                                            href={item.htmlPath!}
                                            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/20 hover:border-yellow-500/40 rounded-full text-white text-sm font-medium transition-all duration-200 whitespace-nowrap"
                                        >
                                            <Globe className="w-5 h-5" />
                                            <span>Ler online</span>
                                        </a>
                                    ...
                                    {item.pdfAvailable ? (
                                        <a
                                            href={item.pdfPath!}
                                            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 hover:border-amber-500/40 rounded-full text-white text-sm font-medium transition-all duration-200 whitespace-nowrap"
                                        >
                                            <FileText className="w-5 h-5" />
                                            <span>PDF</span>
                                        </a>
