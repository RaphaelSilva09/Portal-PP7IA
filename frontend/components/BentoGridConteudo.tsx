            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <a
                        href="/newsletter"
                        id="newsletter"
                        className="col-span-1 md:col-span-3 group relative overflow-hidden rounded-3xl min-h-44 transition-all duration-500 hover:scale-[1.01] block cursor-pointer"
                    ...
                    <a
                        ...
                        id="especial"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 transition-all duration-300 hover:bg-white/[0.07] hover:border-yellow-500/30 hover:shadow-[0_0_30px_rgba(234,179,8,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                    ...
                    <a
                        ...
                        id="radar"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-orange-500/30 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                        <div className="relative z-10 h-full flex flex-col p-4 sm:p-5 gap-3">
                    ...
                    <a
                        href="/mini-livros"
                        id="mini-livros"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-green-500/30 hover:shadow-[0_0_30px_rgba(34,197,94,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                        <div className="relative z-10 h-full flex flex-col p-4 sm:p-5 gap-3">
                    ...
                    <a
                        href="/biblioteca"
                        id="biblioteca"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-purple-500/30 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                        <div className="relative z-10 h-full flex flex-col p-4 sm:p-5 gap-3">
                    ...
                    <a
                        href="/estudar"
                        id="estudar"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 cursor-pointer transition-all duration-300 hover:bg-white/[0.07] hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                        <div className="relative z-10 h-full flex flex-col p-4 sm:p-5 gap-3">
                            <div className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div
                        id="ensinar"
                        className="col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 transition-all duration-300 hover:bg-white/[0.07] hover:border-pink-500/30 hover:shadow-[0_0_30px_rgba(236,72,153,0.15)] block min-h-40"
                        style={{ scrollMarginTop: "100px" }}
                    >
                        <div className="relative z-10 h-full flex flex-col p-4 sm:p-5 gap-3">
