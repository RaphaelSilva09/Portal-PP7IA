                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-3">
                                {latest.htmlAvailable ? (
                                    <a
                                        ...
                                        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-cyan-700 hover:bg-cyan-800 border border-cyan-800 rounded-full text-white font-medium text-sm sm:text-base transition-colors duration-300 whitespace-nowrap"
                                    >
                                ...
                                {latest.pdfAvailable ? (
                                    <a
                                        href={latest.pdfPath!}
                                        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-teal-700 hover:bg-teal-800 border border-teal-800 rounded-full text-white font-medium text-sm sm:text-base transition-colors duration-300 whitespace-nowrap"
                                    >
                    ...
                    {older.map((item: Estudar) => (
                        <div
                            ...
                            className="col-span-1 group relative overflow-hidden rounded-3xl min-h-[200px] bg-card/80 backdrop-blur-sm border border-border cursor-pointer transition duration-300 hover:bg-accent/40 hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]"
                        >
                            <div className="relative z-10 h-full flex flex-col items-center text-center p-6 sm:p-8">
                                ...
                                <div className="flex flex-wrap md:flex-nowrap gap-3 mt-auto justify-center">
                                    {item.htmlAvailable ? (
                                        <a
                                            href={item.htmlPath!}
                                            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-cyan-700 hover:bg-cyan-800 border border-cyan-800 rounded-full text-white text-sm font-medium transition-colors duration-200 whitespace-nowrap"
                                        >
                                            <Globe className="w-5 h-5" />
                                            <span>Ler agora</span>
                                        </a>
                                    ...
                                    {item.pdfAvailable ? (
                                        <a
                                            href={item.pdfPath!}
                                            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-teal-700 hover:bg-teal-800 border border-teal-800 rounded-full text-white text-sm font-medium transition-colors duration-200 whitespace-nowrap"
                                        >
                                            <FileText className="w-5 h-5" />
                                            <span>PDF</span>
                                        </a>
