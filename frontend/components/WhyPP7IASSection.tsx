...
export default function WhyPP7IASSection() {
    return (
        <section id="why-pp7ias" className="py-12 sm:py-16 lg:pb-20 lg:pt-10 px-4 sm:px-6 lg:px-8 bg-background">
            <div className="max-w-4xl mx-auto">
                {/* Linha Horizontal Superior */}
                    <div className="w-full h-px bg-gradient-to-r from-transparent via-border/80 to-transparent mb-8 sm:mb-12" />
                ...
                {/* Linha Horizontal Inferior */}
                    <div className="w-full h-px bg-gradient-to-r from-transparent via-border/80 to-transparent mt-8 sm:mt-12" />
            </div>
        </section>
    );
}
