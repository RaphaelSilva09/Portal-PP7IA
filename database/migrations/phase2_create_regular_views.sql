...
COMMENT ON VIEW vw_searchable_content IS 
  'Unified search view across 4 content tables with FTS support. ' ||
  'Uses security_invoker=true to inherit RLS from base tables. ' ||
  'Search example: SELECT * FROM vw_searchable_content ' ||
