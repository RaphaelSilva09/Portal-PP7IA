-- =============================================================================
-- Migration: add_part_order_and_ebook_id_to_mini_livros
-- Date: 2026-04-07
-- =============================================================================
-- Adds a stable visual grouping field for the fixed mini-livro tabs.
-- part_order controls the UI tab (1, 2, 3). ebook_id is an optional FK to a
-- compiled ebook. The legacy relative_ebook column is intentionally kept for a
-- later cleanup migration after the app is deployed and verified.
-- =============================================================================
